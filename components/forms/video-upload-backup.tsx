...
//       // Clear unsaved changes BEFORE calling onLinksChange
//       unsavedChangesRef.current = [];
...
//         onOpenChange={(open) => {
//           if (!open) {
//             // Only save to unsaved changes if we actually have changes
//             if (buttonForms.length > 0) {
//               // Check if changes are different from current video.links
//               const hasChanges =
//                 JSON.stringify(buttonForms) !==
//                 JSON.stringify(
//                   (video.links || []).map((link) => ({
//                     id: link.id,
//                     label: link.label,
