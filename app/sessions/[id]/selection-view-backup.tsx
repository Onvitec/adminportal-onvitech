// before navigaiton and video links
...
//       try {
//         // Fetch videos with questions and answers
...
//         // Process videos to match the structure we need
...
//         const allQuestions = processedVideos.flatMap((video) =>
//           video.questions.map((question:any) => ({
//             ...question,
//             video_id: video.id,
//             answers: question.answers.map((answer:any) => ({
//               ...answer,
//               destination_video: answer.destination_video_id
//                 ? processedVideos.find((v) => v.id === answer.destination_video_id)
//                 : null,
//             })),
//           }))
//         );
